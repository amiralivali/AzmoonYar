...
public static class Mapper
{
    ...
    {
        return new OptionalQuestion(dto.Id,dto.LessonId,
            dto.QuestionText,dto.Picture,dto.DifficultyLevelId, dto.Option1, dto.Option2, dto.Option3,dto.Option4);
    }
    public static OptionalDto MapToDto(this OptionalQuestion dto)
    {
        return new OptionalDto(dto.Id,dto.LessonId,
            dto.QuestionText,dto.Picture,dto.DifficultyLevelId, dto.Option1, dto.Option2, dto.Option3,dto.Option4);
    }
